...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Asa\\Desktop\\SDEV Programming\\SDEV255\\Final\\SDEV255Final\\prismaCLI\\client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "88713bcca67a035baac70559db1137720096d736a0e578faa33eda833e88f7a4",
  "copyEngine": true
}
...
path.join(process.cwd(), "prismaCLI/client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prismaCLI/client/schema.prisma")
